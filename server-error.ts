...
// Exposed endpoint to send a fake nonce
// This is here to simulate what happens when the nonce passed
// to Stencil does not match the nonce in the CSP
app.get('/nonce', function (_, res) {
  res.send({ nonce: 'r4nd0m' });
});
